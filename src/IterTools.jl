...
Iterate over every subset of the indexable collection `xs`. You can restrict the subsets to
a specific size `k`.
...
# Iterate over all subsets of an indexable 
			with a given *statically* known size
